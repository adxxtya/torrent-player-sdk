!(function (e) {
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ =
      ...
      iframe_resizer__WEBPACK_IMPORTED_MODULE_2___default =
    ...
    class WebtorGenerator {
      ...
      push(data) {
        ...
        let el = null;
        if (dd.el) el = dd.el;
        else if (((el = document.getElementById(dd.id)), !el))
          throw `Failed to find element with id "${dd.id}"`;
        ...
        const params = { id: id, mode: dd.mode },
  ...
  function (e, t, n) {
    ...
    function r(e, t = {}) {
      for (const n of e) {
        ...
        let i = null,
          r = null;
        e && e.match("^magnet:.*") && (i = e),
          ((e && e.match(".torrent$")) ||
            (e && "application/x-bittorrent" == n.getAttribute("type"))) &&
            (r = e),
          n.getAttribute("data-torrent") &&
            (r = n.getAttribute("data-torrent"));
        const a = n.parentNode,
          d = n.getAttribute("width"),
          u = n.getAttribute("height"),
          s = n.getAttribute("poster"),
          c =
            "" == n.getAttribute("controls") ||
            "true" == n.getAttribute("controls"),
          l = {};
        for (const e of n.attributes)
          if ("data-config" != e.name && e.name.startsWith("data-")) {
            let t = e.value;
            try {
        ...
        const f = [];
        for (const e of n.querySelectorAll("track"))
          f.push(
            o({
        ...
        n.getAttribute("class") &&
          g.setAttribute("class", n.getAttribute("class")),
          n.getAttribute("id") && g.setAttribute("id", n.getAttribute("id"));
        let h = {
          el: g,
          magnet: i,
          torrentUrl: r,
        ...
        (h = Object.assign({}, t, o(h), l, m)),
          a.replaceChild(g, n),
          window.webtor.push(o(h));
      }
    }
    (window.webtor = Object(i.a)(window.webtor)),
      r(document.querySelectorAll("video")),
      r(document.querySelectorAll("a[download]"), {
        mode: "download",
        width: "400px",
      });
  },
      ...
      function A(e) {
        ...
        function o(e) {
          var t = Number(p[S]["max" + e]),
            ...
            i = e.toLowerCase(),
            o = Number(A[i]);
          M(S, "Checking " + i + " is in range " + n + "-" + t),
            o < n && ((o = n), M(S, "Set " + i + " to min value")),
            o > t && ((o = t), M(S, "Set " + i + " to max value")),
            (A[i] = "" + o);
        }
        function r(e) {
          ...
          (n = function () {
            ...
            L(
              ...
              "pageInfo:" +
                ...
                (i = A.iframe.getBoundingClientRect()),
                JSON.stringify({
        ...
        "[iFrameResizerChild]Ready" === P
          ...
          : l === ("" + P).substr(0, f) && P.substr(f).split(":")[0] in p
          ? ((w = P.substr(f).split(":")),
            ...
            (S = A.id),
            p[S] && (p[S].loaded = !0),
            (b = A.type in { true: 1, false: 1, undefined: 1 }) &&
              M(S, "Ignoring init message from meta parent page"),
            !b &&
              (function (e) {
                var t = !0;
                return (
                  p[e] ||
                    ((t = !1),
                    x(
                      A.type + " No settings for " + e + ". Message was: " + P
                    )),
                  t
                );
              })(S) &&
              ...
              h &&
                (function () {
                  ...
                  if (
                    ...
                    !(i.constructor === Array
                      ...
                      : ((t = p[S] && p[S].remoteHost),
                        M(S, "Checking connection is from: " + t),
                        n === t))
                  )
                    throw new Error(
                ...
                (function () {
                  switch (
                    (p[S] && p[S].firstRun && p[S] && (p[S].firstRun = !1),
                    A.type)
                  ) {
                    case "close":
                      C(A.iframe);
                    ...
                    case "pageInfoStop":
                      p[S] &&
                        p[S].stopPageInfo &&
                        (p[S].stopPageInfo(), delete p[S].stopPageInfo);
                      break;
                    case "inPageLink":
                      !(function (e) {
                        var t,
  ...
  function (e, t, n) {
    !(function (t) {
        ...
        !(function () {
          ...
          (function () {
            ...
            "iFrameResizer" in window &&
              ...
              (N = "onMessage" in t ? t.onMessage : N),
              (k = "onReady" in t ? t.onReady : k),
              (M = "targetOrigin" in t ? t.targetOrigin : M),
              (f =
                "heightCalculationMethod" in t ? t.heightCalculationMethod : f),
              (S =
                "widthCalculationMethod" in t ? t.widthCalculationMethod : S),
              (f = e(f, "height")),
              (S = e(S, "width")));
            var t;
          ...
          (C.parentIFrame = {
            ...
            getPageInfo: function (e) {
              "function" == typeof e
                ? ((z = e), Oe(0, 0, "pageInfo"))
                : ((z = function () {}), Oe(0, 0, "pageInfoStop"));
            },
            moveToAnchor: function (e) {
              h.findTarget(e);
            },
      ...
      function se() {
        f = ue(f, "bodyOffset", Y, "height");
      }
      function ce() {
        S = ue(S, "scroll", Q, "width");
      }
      function le() {
        var e;
        !0 === n
      ...
      function ge(e, t) {
        ...
        return (
          ...
          (function (e) {
            e > A / 2 &&
              te("Event throttle increased to " + (A = 2 * e) + "ms");
          })(a),
          o
        );
      }
